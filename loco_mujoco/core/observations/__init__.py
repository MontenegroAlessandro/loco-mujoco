...
from .goals import *
from .goals_foot_placement import GoalRandomFootPlacement, GoalRandomChangingFootPlacement, GoalDoubleFootPlacement, GoalVelocityAndObstacles
...
GoalVelocityAndObstacles.register()