...
class MjxUnitreeG1(UnitreeG1):
    ...
    def _modify_spec_for_mjx(self, spec: MjSpec):
        ...
        torso_geoms = ["torso_col"]

        left_arm_geoms = ["left_shoulder_yaw_col", "left_wrist_roll_col", "left_wrist_pitch_col", "left_wrist_yaw_col"]
        right_arm_geoms = ["right_shoulder_yaw_col", "right_wrist_roll_col", "right_wrist_pitch_col", "right_wrist_yaw_col"]

        left_forearm_geoms = ["left_wrist_roll_col", "left_wrist_pitch_col", "left_wrist_yaw_col"]
        right_forearm_geoms = ["right_wrist_roll_col", "right_wrist_pitch_col", "right_wrist_yaw_col"]
