...
#         jax.debug.print("Creating BoosterT1 environment with xml file: {}", observation_spec)
#         print(f"Creating BoosterT1 environment with xml file: {observation_spec}")
...
#         """
#         return (loco_mujoco.PATH_TO_MODELS / "booster_t1" / "booster_t1_dfki.xml").as_posix()
...
class BoosterT1(BaseRobotHumanoid):
    ...
    def __init__(self, spec: Union[str, MjSpec] = None,
        ...
        if self.mjx_enabled:
            ...
            # modify the spec to no-contact all geoms which end in "_col"
            for g in spec.geoms:
                if g.name.endswith("_col"):
                    g.contype = 0
                    g.conaffinity = 0
                    # g.delete()
